...
export default function Entreprise() {
  ...
  // const myEntreprise = entrepriseList
  const myEntreprise = entrepriseList.find((obj) => obj.owner && obj.owner._id === user?.user?.user?.userId);
  console.log("myEntreprisee", myEntreprise);
  ...
  return (
    <>
      ...
      <Container sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }} >
        ...
        {
          (myEntreprise?.length === 0 || myEntreprise === undefined) ?
