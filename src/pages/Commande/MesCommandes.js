...
export default function MesCommandes() {
    ...
    const filteredCommandes = applySortFilter(commandes.filter((value) => value.parent_id === 0), getComparator(order, orderBy), filterNumber);
            ...
            <Container >
                ...
                <Card>
                        ...
                        <TableContainer sx={{ minWidth: 800 }}>
                            <Table>
                                <CommandeListHead
                                    ...
                                    rowCount={commandes.filter((value) => value.parent_id === 0).length}
                    ...
                    <TablePagination
                        ...
                        component="div"
                        count={commandes.filter((value) => value.parent_id === 0).length}
