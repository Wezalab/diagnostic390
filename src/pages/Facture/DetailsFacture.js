...
export default function DetailsFacture() {
  ...
  return (
    <>
      <Helmet>
        <title> TRANSFORME | Details de la facture </title>
      </Helmet>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 5 }} >
          <Box>
            <Box sx={{ display: 'flex', flexDirection: 'row' }}>
              <Link href="/dashboard/factures" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }} variant="subtitle2" underline="hover">
